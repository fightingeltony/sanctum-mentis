...
Verträgt das Tableau-Thema eine kühle, vollständige Behandlung, ohne dass dadurch der wesentliche Charakter verloren geht? Wenn das Thema einen meditativen, lebensweltlichen oder phänomenologischen Anker hat, der durch Vollständigkeit zerstört würde, ist es **kein Hard-Mode-Material**.

Klassischer Misserfolg: Wenn eine "Landkarte des Selbst" im Hard-Modus gebaut würde, wäre sie akademisch sauber und kuratorisch tot.
...
Wo wurden komplexe Positionen unzulässig vereinfacht, um in einen Quadranten zu passen? Welche Denker werden durch ihre Verortung verzerrt?

**Konkret prüfen:**
- Welche Denker haben im Tableau eine *eindeutige* Position, obwohl ihr Werk *mehrere* Positionen vertritt? (Beispiel: Wittgenstein früh ≠ Wittgenstein spät.)
- Welche Quadranten sind so eng, dass Denker hineingequetscht werden, deren Positionen eigentlich daneben liegen?
- Welche Positionen wären besser durch *zwei* Knoten als durch einen repräsentiert?

### 2. Kategorienfehler

Passt die Zuordnung der Konzepte zu ihren Typen (Axiom, Theorie, Konzept, Phänomen, Methode) wirklich zur historischen und systematischen Realität? Wo ist die Etikettierung schief?

**Konkret prüfen:**
- Werden *Methoden* als *Theorien* deklariert oder umgekehrt? (Beispiel: Phänomenologie als Methode vs. als Theorie der Bewusstseinsstruktur.)
- Werden *Phänomene* (Beobachtbare) mit *Konzepten* (Begrifflichkeiten) vermischt?
- Sind *Axiome* tatsächlich axiomatisch, oder sind sie kontingente historische Grundannahmen?

### 3. Blinde Flecken

Welcher entscheidende Gegenentwurf, welche zentrale Tradition, welcher methodische Ansatz fehlt im Spannungsfeld, um eine echte Synthese zu ermöglichen?

**Konkret prüfen:**
- Welche etablierte Schule taucht im Tableau nicht auf, obwohl sie zu den Hauptpositionen des Feldes gehört?
- Welche nicht-westliche Tradition wurde übersehen?
- Welcher zeitgenössische Strang (letzte 20 Jahre) fehlt?
- Welche methodische Alternative wurde nicht repräsentiert?

### 4. Logik der Kanten

Ergeben die `influences` (critique, development, synthesis, drift, parallel, rejection) historisch und argumentativ Sinn, oder sind sie oberflächliche Assoziationen, die einen Zusammenhang nur behaupten?

**Konkret prüfen:**
- Welche Kanten behaupten Einfluss, obwohl die historische Rezeptionslinie nicht belegt ist?
- Welche Kanten sind als `critique` deklariert, obwohl sie eigentlich `development` sind (oder umgekehrt)?
- Welche Kanten fehlen, die historisch zwingend wären?
- Sind die Kanten-Texte argumentativ präzise oder bleiben sie bei Schlagwörtern?

---

## Anti-Höflichkeits-Klauseln

Hard-Mode-Bewertungen und -Synthesen folgen diesen expliziten Regeln:
...
## Was vom Mild-Modus übernommen wird
...
Subtitle und Intro sprechen weiterhin "du". Auch Hard-Mode-Tableaus laden persönlich ein, nicht institutionell.

### Achsen-Hints

Auch im Hard-Mode bekommen alle vier Pole erklärende Untertitel. Die Begriffe sind tendenziell technischer, deshalb sind die Hints umso wichtiger.

### Schema-Felder, Validierungs-Checkliste

Identisch zum Mild-Modus. Siehe `mild-mode.md` Abschnitt "Schema-Felder" und "Validierungs-Checkliste".

---

## Verteilter Hard-Mode
...
## Architekt-Prompt für Hard-Mode-Bauten

Beim Start eines Hard-Mode-Architekt-Chats:
...
## Inquisitor-Prompt für Hard-Mode-Prüfungen

Beim Start eines Inquisitor-Chats:

```
Du bist ein gnadenloser akademischer Kritiker und Experte für Logik und Philosophiegeschichte.
Analysiere den beigefügten Datensatz im Sanctum-Mentis-Format gegen vier Prüfsteine:

1. Reduktionismus: Wo wurden komplexe Positionen unzulässig vereinfacht?
   Welche Denker werden durch ihre Verortung verzerrt?

2. Kategorienfehler: Passt die Zuordnung der Konzepte (Axiom / Theorie / Konzept /
   Phänomen / Methode) zur historischen und systematischen Realität?

3. Blinde Flecken: Welcher entscheidende Gegenentwurf, welche zentrale Tradition,
   welcher methodische Ansatz fehlt im Spannungsfeld?

4. Logik der Kanten: Ergeben die influences (critique / development / synthesis /
   drift / parallel / rejection) historisch und argumentativ Sinn, oder sind sie
   oberflächliche Assoziationen?

Sei hart, präzise, mach konkrete Verbesserungsvorschläge auf JSON-Ebene:
welche Felder zu ändern, welche Denker zu ergänzen oder zu streichen, welche
...
## Was Hard-Mode-Tableaus von Mild-Tableaus optisch unterscheidet

Aus Nutzer-Perspektive sollte der Unterschied nicht primär in der Tonalität sichtbar werden, sondern in der **Dichte des Netzes**:

- Mehr Denker pro Quadrant
- Mehr Influences pro Hub
- Längere L3–L5-Texte mit dichteren Fachbegriffsspuren
- Mehr Tooltips, vor allem auf L3–L5

Aber: Auf L1 sollten sich Hard- und Mild-Tableaus nicht stark unterscheiden. Die Eingangstür bleibt einladend.
...
## Verhältnis zum Mild-Modus

Dieser Prompt und `mild-mode.md` sind **zwei Modi mit klarer Hierarchie**, nicht zwei parallele Optionen:
